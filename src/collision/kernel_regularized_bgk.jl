...
@kernel function stream_collide_regularized_bgk!(
    ...
    # Phase 2: cumulant params (unused by BGK, kept for uniform interface)
    _omega_bulk_param::Float32,
    _omega_3_param::Float32,
    _omega_4_param::Float32,
    _adaptive_omega4::Int32,
    _lambda_param::Float32,
    _limiter_type::Int32,
    # Compressibility correction: 0=off, 1=on (uniform interface)
        ...
        @inbounds begin
            ...
            if is_obs
                ...
                for k in Int32(1):Int32(27)
                    ...
                    feq = calculate_equilibrium_auto(rho, ux_eq, uy_eq, uz_eq,
                ...
                for k in Int32(1):Int32(27)
                    ...
                    feq = calculate_equilibrium_auto(rho, ux_eq, uy_eq, uz_eq,
                              w_k, cx_f, cy_f, cz_f, compressible_corr)
